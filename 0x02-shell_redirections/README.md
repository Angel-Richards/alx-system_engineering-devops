...
6). Write a script that displays the third line of the file iacta in thhe working directory.Without using 'sed'.
7). Write a shell script that creates a file named exactly \*\\'"Best School"\'\\*$\?\*\*\*\*\*:) containing the text Best School ending by a new line.
8). Write a script that writes into the file ls_cwd_content the result of the command ls -la.
9). Write a script that duplicates the last line of the file iacta in the working directory.
